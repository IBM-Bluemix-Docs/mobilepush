...
5. 'Android 앱에 Firebase 추가' 창에서 패키지 이름을 입력하여 애플리케이션의 패키지 이름을 포함하십시오. 앱 닉네임 필드는 선택사항입니다. **앱 등록**을 클릭하십시오.  
...
**참고**: FCM은 GCM(Google Cloud Messaging)의 새 버전입니다. 새 앱에 FCM 신임 정보를 사용하십시오. 기존 앱은 계속해서 GCM 구성으로 작동합니다. 
