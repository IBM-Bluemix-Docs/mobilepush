...
After obtaining the credentials, the next step is to [Create a push instance and set it up with the obtained credentials](push_step_2.html).
...
To set up the service for Chrome, Firefox browsers, and Chrome Apps & Extensions,  see [Configure a Push service instance](push_step_2.html).
