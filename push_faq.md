...
Follow the steps mentioned in [Step 3: Set up Push service client SDKs](/docs/services/mobilepush?topic=mobile-pushnotification-push_step_3). Also, ensure that:
